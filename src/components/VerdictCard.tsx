...
export default function VerdictCard({ verdict }: VerdictCardProps) {
  return (
    <div className={`rounded-xl border p-4 space-y-3 ${statusBgLight[verdict.overall]}`}>
      {/* Overall badge */}
      ...
      {verdict.alternatives && verdict.alternatives.length > 0 && (
        <div className="pt-2 border-t border-surface-700/50">
          <p className="text-xs text-surface-400 mb-1">Suggested alternatives:</p>
