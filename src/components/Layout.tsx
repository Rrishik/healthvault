// HealthVault — App shell with bottom navigation
...
const navItems = [
  ...
  { to: '/scanner', labelKey: 'nav.scan', icon: ScanIcon },
  ...
  return (
    <div className="flex flex-col h-screen bg-surface-950">
      ...
      <header className="bg-surface-900 border-b border-surface-700 px-4 py-3 flex items-center gap-3">
        ...
        <h1 className="text-lg font-semibold text-surface-100">HealthVault</h1>
      </header>
      ...
      {/* Bottom navigation */}
      <nav className="bg-surface-900 border-t border-surface-700 px-2 py-1 flex justify-around">
...
// ---------- Inline SVG icons (kept minimal to avoid extra deps) ----------
